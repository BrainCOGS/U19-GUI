...
// request character for squal
const char squal_char = 'q';
  // reply with SQUAL when this char received over serial
...
void loop() {
 ...
 // --- handle usb serial communication ---
  ...
  if (SerialUSB.available()) {
    ...
    // else if input is requesting SQUAL
    else if (c == squal_char) {

    // send SQUAL to host
    SerialUSB.write(SQUAL2);
