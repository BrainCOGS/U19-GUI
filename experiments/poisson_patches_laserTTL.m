function code = poisson_patches_laserTTL
...
try
  ...
  % decide what to do about the laser
...
function vr = initializeTrialWorld(vr)
  ...
  if vr.warmupIndex < 1 && ~vr.easyBlockFlag
      vr.lsrON = binornd(1,vr.P_on,1); % will laser be ON or OFF?
  else
      vr.lsrON = 0; % laser always off in warmup trials
  end
...
function vr = setupTrials(vr, shaping)
  ...
  vr.currentState       = 0; % state of laser TTL
  ...
  cfg.blockData         = { 'mazeID', 'mainMazeID', 'motionBlurRange', 'iterStr'    ...
                          ...
                          , 'stimulusConfig', 'stimulusSet'  , 'frozenStimuli','lsrepoch','P_on'};
...
if ~vr.lsrON
    ...
    switch vr.lsrepoch
        ...
        case 'whole+reward' % assuming ramp down time doesn' really matter here
            if vr.stateCode == virmenStateCodes.WithinTrial || vr.stateCode == virmenStateCodes.DuringReward
                vr.currentState = 1;
            else
                vr.currentState = 0;
            end
...
if vr.currentState > 0 && vr.prevState == 0
...
epochList =   {'whole+reward';'whole';'cue';'cueHalf2';'cueHalf1';'mem'; ...
               'memHalf1';'choice';'reward';'iti';'reward+iti'}; % trial epoch options
                       
obj.pON_txt = uicontrol (obj.fig,                                   ...
                        'Style',                'text',             ...
                        'String',               'P (on):',          ...
                        'Units',                'normalized',       ...
                        ...
                        'fontsize',             14);                        
obj.pON = uicontrol     (obj.fig,                                   ...
                        'Style',                'edit',             ...
                        'Units',                'normalized',       ...
                        'String',               num2str(0.1),       ...
                        'Position',             [.55 .72 .35 .18],  ...
                        'Callback',             {@pON_callback,obj,vr},      ...
                        'fontsize',             13);
obj.epoch_txt = uicontrol (obj.fig,                         ...
                        'Style',                'text',             ...
                        'String',               'Trial epoch:',     ...
                        'Units',                'normalized',       ...
                        ...
                        'horizontalAlignment',  'right',            ...
                        'fontsize',             14);
obj.epoch = uicontrol   (obj.fig,                                   ...
                        'Style',                'popupmenu',        ...
                        'Units',                'normalized',       ...
                        'String',               epochList,          ...
                        'Value',                1,                  ...
                        'Position',             [.55 .36 .4 .25],   ...
                        'Callback',             {@epoch_callback,obj,vr,epochList},    ...
                        'fontsize',             13);   
                      
obj.ready = uicontrol   (obj.fig,                                   ...                              
                        'String',               'GO!',              ...
                        'Style',                'pushbutton',       ...
                        'Units',                'normalized',       ...
                        'Position',             [.33 .10 .33 .25],  ...
                        'Callback',             {@ready_callback,obj,vr},    ...
...
function vr = pON_callback(~,event,obj,vr)

vr.P_on = str2double(get(obj.pON,'String'));
set(obj.pON,'String',num2str(vr.P_on));

end

% select laser ON trial epoch with drop down menu
function vr = epoch_callback(~,event,obj,vr,epochList)

vr.lsrepoch   = epochList{get(obj.epoch,'Value')};
end

% start virmen experiment
function vr = ready_callback(~,event,obj,vr)
