function [mazes, criteria, globalSettings, vr] = PoissonBlocksCondensed3m_nocueswithguides(vr)
  ...
  mazes     = struct( 'lStart'          , {5     , 5     , 30    , 30    , 30    , 30    , 30    , 30         , 30    , 30    , 30    , 30   , 30    }   ...
                    , 'lCue'            , {45    , 45    , 120   , 120   , 220   , 220   , 200   , 200        , 200   , 200   , 200   , 200  , 200   }   ...
                    , 'lMemory'         , {10    , 10    , 20    , 20    , 20    , 20    , 100   , 100        , 100   , 100   , 100   , 100  , 100   }   ...
                    , 'tri_turnHint'    , {true  , false , true  , false , true  , false , true  , false      , false , false , false , true , true  }   ...
  ...
  criteria  = struct( 'numTrials'       , {80    , 80    , 80    , 80    , 10    , 80    , 80    , 80         , 80    , 80    , 80    , 80   , 80    }   ...
                    , 'numTrialsPerMin' , {2     , 2     , 2     , 2     , 2     , 2     , 2     , 2          , 2     , 2     , 2     , 2    , 2     }   ...
                    , 'criteriaNTrials' , {inf   , 100   , inf   , 100   , inf   , 100   , 100   , 10000      , 100   , 100   , 100   , 100  , 100   }   ...
                    , 'warmupNTrials'   , {[]    , 20    , []    , 20    , []    , 20    , []    , 20         , 10    , 10    , 10    , 20   , 30    }   ...
                    , 'numSessions'     , {2     , 2     , 0     , 2     , 0     , 2     , 0     , 1          , 1     , 1     , 1     , 1    , 1     }   ...
                    , 'performance'     , {0.8   , 0.8   , 0     , 0.7   , 0     , .7    , 0.8   , 0.75       , 0.7   , 0.65  , 0.65  , 0.65 , 0.8   }   ...
                    , 'maxBias'         , {0.2   , 0.2   , inf   , 0.2   , inf   , 0.15  , inf   , 0.15       , 0.20  , 0.20  , 0.20  , 0.20 , 0.15  }   ...
                    , 'warmupMaze'      , {[]    , 1     , []    , 3     , []    , 5     , []    , 7          , 4     , 4     , 4     , 4    , 4     }   ...
                    , 'warmupPerform'   , {[]    , .5    , []    , .5    , []    , 0.5   , []    , .5         , 0.85  , .85   , .85   , 0.85 , 0.8   }   ...
                    , 'warmupBias'      , {[]    , 0.5   , []    , .5    , []    , 0.5   , []    , .5         , 0.1   , .1    , .1    , 0.1  , 0.1   }   ...
                    , 'warmupMotor'     , {[]    , .5    , []    , .5    , []    , .5    , []    , .5         , 0.75  , .75   , .75   , 0.75 , 0     }   ...
                    , 'easyBlock'       , {nan   , 1     , nan   , 3     , nan   , 5     , nan   , 7          , 7     , 4     , 4   , nan  , 4     }   ... maze ID of easy block    
                    , 'easyBlockNTrials', {10    , 10    , 10    , 10    , 10    , 10    , 10    , 10         , 10    , 10    , 10    , 10   , 10    }   ... number of trials in easy block   
                    , 'numBlockTrials'  , {20    , 40    , 20    , 40    , 20    , 40    , 20    , 40         , 40    , 400   , 40    , 40   , 40    }   ... number of trials for sliding window perfromance
                    , 'blockPerform'    , {.7    , .5    , .7    , .50   , .7   , .50    , .7    , .6         , .6    , .55   , .5    , .55  , .7    }   ... performance threshold to go into easy block
                    );
