function [mazes, criteria, globalSettings, vr] = PoissonBlocksCondensed3m_justguides(vr)
  ...
  mazes     = struct( 'lStart'          , {5     , 30    , 30    , 30    , 30    , 30    , 30    , 30         , 30    , 30    , 30    , 30   , 30    }   ...
                    , 'lCue'            , {45    , 120   , 220   , 280   , 300   , 280   , 200   , 200        , 200   , 200   , 200   , 200  , 200   }   ...
                    , 'lMemory'         , {10    , 20    , 20    , 20    , 0     , 20    , 100   , 100        , 100   , 100   , 100   , 100  , 100   }   ...
