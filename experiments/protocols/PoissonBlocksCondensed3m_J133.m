function [mazes, criteria, globalSettings, vr] = PoissonBlocksCondensed3m_J133(vr)
  ...
  criteria  = struct( 'numTrials'       , {10    , 40    , 80    , 80    , 80    , 80    , 80    , 80         , 80    , 80    , 80    , 80   , 80    }   ...
                    ...
                    , 'easyBlockNTrials', {10    , 10    , 10    , 10    , 10    , 10    , 5     , 7          , 10    , 10    , 10    , 10   , 10    }   ... number of trials in easy block   
                    , 'numBlockTrials'  , {20    , 20    , 20    , 20    , 40    , 40    , 15    , 20         , 40    , 40    , 40    , 40   , 40    }   ... number of trials for sliding window perfromance
                    , 'blockPerform'    , {.7    , .7    , .7    , .7    , .6    , .6    , .6    , .6        , .6    , .6    , .55   , .55  , .7    }   ... performance threshold to go into easy block
                    );
