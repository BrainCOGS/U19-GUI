function [mazes, criteria, globalSettings, vr] = PoissonBlocksCondensed3m_easy12long(vr)
  ...
  criteria  = struct( 'numTrials'       , {10    , 40    , 80    , 80    , 80    , 80    , 80    , 80         , 80    , 80    , 80    , 80   , 80    }   ...
                    ...
                    , 'easyBlock'       , {nan   , nan   , nan   , nan   , 4     , 4     , 4     , 4          , 7     , 12    , 12    , nan  , 4     }   ... maze ID of easy block    
                    , 'easyBlockNTrials', {10    , 10    , 10    , 10    , 10    , 10    , 10    , 10         , 10    , 20    , 20    , 10   , 10    }   ... number of trials in easy block   
                    , 'numBlockTrials'  , {20    , 20    , 20    , 20    , 40    , 40    , 40    , 40         , 40    , 40    , 40    , 40   , 40    }   ... number of trials for sliding window perfromance
                    , 'blockPerform'    , {.7    , .7    , .7    , .7    , .7    , .7    , .7    , .65        , .6    , .65   , .6   , .55  , .7    }   ... performance threshold to go into easy block
                    );
