function [mazes, criteria, globalSettings, vr] = PoissonPatchesB1(vr)
  ...
  mazes     = struct( 'lStart'            , {5         , 30        , 30        , 30        , 30        , 30        , 30        , 30        , 30         , 30         , 30         , 30         , 30         }   ...
                    , 'lCue'              , {40        , 100       , 180       , 280       , 350       , 350       , 350       , 350       , 350        , 350        , 300        , 250        , 250        }   ...
                    , 'lMemory'           , {10        , 10        , 20        , 20        , 50        , 50        , 50        , 50        , 50         , 50         , 100        , 150        , 150        }   ...
                    , 'tri_turnHint'      , {inf       , inf       , 120       , 170       , 200       , false     , false     , false     , false      , false      , false      , false      , false      }   ... % cm before interesection
                    , 'hHint'             , {40        , 40        , 35        , 30        , 25        , 25        , 25        , 25        , 25         , 25         , 25         , 25         , 25         }   ...
