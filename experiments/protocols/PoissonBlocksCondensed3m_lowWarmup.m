function [mazes, criteria, globalSettings, vr] = PoissonBlocksCondensed3m_lowWarmup(vr)
  ...
  criteria  = struct( 'numTrials'       , {10    , 40    , 80    , 80    , 80    , 80    , 80    , 80         , 80    , 80    , 80    , 80   , 80    }   ...
                    ...
                    , 'blockPerform'    , {.7    , .7    , .7    , .7    , .4    , .4    , .4    , .65        , .6    , .6    , .55   , .55  , .7    }   ... performance threshold to go into easy block
                    );
