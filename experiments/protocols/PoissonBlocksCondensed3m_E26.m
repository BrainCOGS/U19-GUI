function [mazes, criteria, globalSettings, vr] = PoissonBlocksCondensed3m_E26(vr)
  ...
  criteria  = struct( 'numTrials'       , {10    , 40    , 80    , 80    , 80    , 80    , 80    , 80         , 80    , 80    , 80    , 80   , 80    }   ...
                    ...
                    , 'easyBlock'       , {nan   , nan   , nan   , nan   , 4     , 4     , 4     , 4          , 7     , 7     , 4     , nan  , 4     }   ... maze ID of easy block    
                    , 'easyBlockNTrials', {10    , 10    , 10    , 10    , 10    , 10    , 10    , 10         , 10    , 10    , 5     , 10   , 10    }   ... number of trials in easy block   
                    , 'numBlockTrials'  , {20    , 20    , 20    , 20    , 40    , 40    , 40    , 40         , 40    , 40    , 60    , 40   , 40    }   ... number of trials for sliding window perfromance
