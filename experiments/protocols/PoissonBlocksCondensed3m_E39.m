function [mazes, criteria, globalSettings, vr] = PoissonBlocksCondensed3m_E39(vr)
  ...
  mazes     = struct( 'lStart'          , {5     , 30    , 30    , 30    , 30    , 30    , 30    , 30         , 30    , 30    , 30    , 30   , 30    }   ...
                    ...
                    , 'cueDuration'     , {nan   , nan   , nan   , nan   , nan   , nan   , nan   , nan        , nan   , nan   , 0.2   , 0.2  , nan   }   ... seconds
                    , 'cueVisibleAt'    , {10    , 10    , 10    , 10    , 10    , 10    , 10    , 10         , 10    , 10    , 10    , 10   , 10    }   ...
                    , 'cueProbability'  , {inf   , inf   , inf   , inf   , inf   , inf   , inf   , 2.5        , 1.6   , 1.2   , 1.2   , 1.2  , inf   }   ...
                    , 'cueDensityPerM'  , {3     , 3.8   , 3.8   , 4.2   , 4.2   , 4.2   , 4.2   , 4.5        , 4.8   , 5     , 5     , 5    , 4.2   }   ...
  ...
  criteria  = struct( 'numTrials'       , {10    , 40    , 80    , 80    , 80    , 80    , 80    , 80         , 80    , 80    , 80    , 80   , 80    }   ...
                    ...
                    , 'performance'     , {0     , 0     , 0.6   , 0.9   , 0.8   , 0.8   , 0.8   , 0.75       , 0.7   , 0.65  , 0.65  , 0.65 , 0.8   }   ...
                    , 'maxBias'         , {inf   , 0.2   , 0.2   , 0.1   , 0.15  , 0.15  , 0.15  , 0.20       , 0.20  , 0.20  , 0.20  , 0.20 , 0.15  }   ...
                    , 'warmupMaze'      , {[]    , []    , []    , []    , 4     , 4     , 4     , [4   ,7]   , 4     , 4     , 4     , 4    , 4     }   ...
                    , 'warmupPerform'   , {[]    , []    , []    , []    , 0.8   , 0.8   , 0.8   , [0.85,0.8] , 0.85  , 0.85  , 0.85  , 0.85 , 0.8   }   ...
                    ...
                    , 'blockPerform'    , {.7    , .7    , .7    , .7    , .7    , .7    , .7    , .65        , .6    , .55   , .55   , .55  , .7    }   ... performance threshold to go into easy block
                    );
